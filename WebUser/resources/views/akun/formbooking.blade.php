            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <div class="mt-3" style="margin-top:10px;float:left;">
                        <input value="{{ Cache::get('booking_waktu_mulai')}}" id="timepkr" name="waktu_mulai" style="width:100px;float:left;" class="wrap-input100 form-control" placeholder="HH:MM" required />
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="mt-3" style="margin-top:10px;float:left;">
                            <input value="{{ Cache::get('booking_waktu_selesai')}}" id="timepkr1" name="waktu_selesai" style="width:100px;float:left;" class="wrap-input100 form-control" placeholder="HH:MM" required/>
